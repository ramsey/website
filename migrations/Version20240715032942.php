 ...
 */
final class Version20240715032942 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Removes the analytics event and device entities';
    }
    ...
    {
        // Recreates the table structures, but all the data is gone.
