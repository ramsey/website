...
class FeedHandlerFactory
{
    public function __invoke(ContainerInterface $container): FeedHandler
    {
        ...
        /** @var XmlResponseFactory $responseFactory */
        $responseFactory = $container->get(XmlResponseFactory::class);

        /** @var RouterInterface $router */
        $router = $container->get(RouterInterface::class);

        return new FeedHandler($postRepository, $template, $responseFactory, $router);
    }
}
